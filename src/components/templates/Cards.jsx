    ...
    <div className="bg-[#1F1E24] flex flex-wrap">
        {
            data.map((c, i)=> <Link to={`/${c.media_type || title}/details/${c.id}`} className="w-[15vh] md:w-[17vh] lg:w-[17%] relative m-4" key={i}>
                ...
                {c.vote_average && <div className="invisible md:visible lg:visible absolute bottom-30 -right-5 w-[50px] h-[50px] text-white flex justify-center items-center rounded-full bg-amber-300">
